...
def write_test(w_array, buffer_lock: Lock()):
    ...
    # write
    # TODO_: beware of deadlock of buffer_lock and lock in class MyBuffer
    buffer_lock.acquire()
...
def read_test(idx):
    ...
    TODO_: add reader-writer lock to avoid accidents
    TODO_: resolve potential conflicts caused by delete
    """
